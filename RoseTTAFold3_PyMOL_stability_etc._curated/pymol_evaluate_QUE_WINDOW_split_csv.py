# -*- coding: utf-8 -*-
"""
pymol_evaluate_QUE_WINDOW_split_csv.py
- 用于评估 QUE 配体对应的 RoseTTAFold3 预测结构
...
REFERENCE_DIR = Path(
    r"C:\Users\Lenovo\Desktop\small_molecule_design\4_RoseTTAFold3\QUE\Skeletal_structure"
)

PREDICTION_DIR = Path(
    r"C:\Users\Lenovo\Desktop\small_molecule_design\4_RoseTTAFold3\QUE\out_QUE_WINDOW"
)

OUTPUT_DIR = Path(
    r"C:\Users\Lenovo\Desktop\small_molecule_design\4_RoseTTAFold3\QUE\metrics_by_backbone"
)

WARNING_LOG = OUTPUT_DIR / "QUE_WINDOW_structure_metrics_warning_log.txt"
...
# 根据用户提供的文件名提取 backbone_id（按字母顺序排序）
BACKBONE_IDS = [
    "buried_0_model_5", "buried_0_model_6", "buried_0_model_7", "buried_0_model_9",
    "buried_1_model_0", "buried_1_model_1", "buried_1_model_4", "buried_1_model_5",
    "buried_1_model_8", "buried_2_model_2", "buried_2_model_3", "buried_2_model_8",
    "buried_2_model_9", "buried_3_model_4", "buried_3_model_5", "buried_3_model_6",
    "buried_3_model_7", "buried_4_model_0", "buried_4_model_1", "buried_4_model_3",
    "buried_4_model_4", "buried_4_model_5", "buried_4_model_6", "buried_4_model_7",
    "buried_4_model_9", "buried_5_model_0", "buried_5_model_1", "buried_5_model_3",
    "buried_5_model_4", "buried_5_model_5", "buried_5_model_6", "buried_5_model_7",
    "buried_5_model_8", "buried_5_model_9", "buried_6_model_0", "buried_6_model_1",
    "buried_6_model_2", "buried_6_model_3", "buried_6_model_4", "buried_6_model_5",
    "buried_6_model_6", "buried_6_model_7", "buried_6_model_8", "buried_7_model_0",
    "buried_7_model_2", "buried_7_model_7", "buried_7_model_9", "buried_8_model_1",
    "buried_8_model_2", "buried_8_model_3", "buried_8_model_5", "buried_8_model_7",
    "buried_8_model_8", "buried_8_model_9", "buried_9_model_3", "partial_3_model_8",
]
...
def find_predicted_path(backbone_id, sample_id):
    """
    兼容以下常见 RF3 输出布局：
    1) out_QUE_WINDOW/buried_X_model_Y_sampleN_model.cif
    2) out_QUE_WINDOW/buried_X_model_Y_sampleN/buried_X_model_Y_sampleN_model.cif
    3) out_QUE_WINDOW 下面任意一层中的同名 CIF 文件
    """
...
# =========================================================
# 批量运行：骨架列表中的每个骨架输出 CSV
# =========================================================

def evaluate_QUE_WINDOW():
    ...
    print("====================================================")
    print("开始进行 QUE_WINDOW RF3 结构评价")
    print("====================================================")
    ...
    if warnings:
        ...
        WARNING_LOG.write_text("无警告：所有骨架及对应 RF3 结构均成功评价。\n", encoding="utf-8")

    print("\n====================================================")
    print("QUE_WINDOW 结构评价完成")
    print("====================================================")
    print(f"生成 CSV 数量：{output_csv_count}（预期 {len(BACKBONE_IDS)}）")
    print(f"总结果行数：{total_rows}（预期 {len(BACKBONE_IDS) * (SAMPLE_END - SAMPLE_START + 1)}）")
...
def view_QUE_WINDOW(backbone_id, sample_id):
...
cmd.extend("evaluate_QUE_WINDOW", evaluate_QUE_WINDOW)
cmd.extend("view_QUE_WINDOW", view_QUE_WINDOW)

print("脚本加载成功。")
print("批量计算命令：evaluate_QUE_WINDOW")
print("单个结构查看命令：view_QUE_WINDOW buried_0_model_5, 1")